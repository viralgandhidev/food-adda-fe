          ...
          <div className="mt-8 flex items-center justify-between">
            ...
            {onSubmit && (
              <button
                ...
                className="inline-flex items-center justify-center rounded-full bg-[#FFD600] px-7 py-2.5 text-[15px] font-semibold text-[#181818] shadow-sm hover:bg-yellow-400 disabled:opacity-60"
              >
