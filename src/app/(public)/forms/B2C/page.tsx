...
export default function B2CFormPage() {
  ...
  const fetchSuppliers = useCallback(async () => {
    try {
      ...
      const params: Record<string, string | number | boolean | undefined> = {
        page,
        limit: 20,
        formType: "B2C", // Only show suppliers who submitted B2C form
      };
  ...
  const submit = async () => {
    try {
      ...
      fd.append("form_type", "B2C");
      fd.append("contact_name", String(form.name || form.company_name || ""));
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 py-12">
        <div className="flex items-baseline justify-between mb-6">
          <div>
            ...
            <h1 className="text-4xl font-extrabold text-[#181818]">B2C</h1>
          </div>
          <button
